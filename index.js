 ...
 */
  ...
  async function runBrowser(invokeType) {
    ...
    async function runWebglGalaxy(loadUsersPromise) {
       ...
       * }} _
       */
      function setupOrbitControls2({ camera, host, clock, scene }) {
        const STEADY_ROTATION_SPEED = 0.2;
        ...
        function initControls() {
          ...
          *  isAlternative: boolean
           ...
           */
          /**
           * @type {PointerInfo[] & { center: THREE.Vector3 } | undefined}
           */
          let pointers;

          const tmpPoint2D = new THREE.Vector2();
          ...
          function addPointer(event, isTouch, isAlternative) {
            if (!pointers) {
              pointers = /** @type {PointerInfo[] & { center: THREE.Vector3 }} */(/** @type {*}*/([]));
