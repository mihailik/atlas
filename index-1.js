  ...
  *  & import ('@atproto/api').AppBskyActorProfile.Record
  ...
  async function runBrowser(invokeType) {
    ...
    async function loadUserList() {
      // fetch('../atlas-db/users/hot.json').then(response => response.json())

      if (window.hot && typeof window.hot === 'object') {
        userList = window.hot;
        return userList;
      }
      ...
      return new Promise(resolve => {
        ...
        jsonpScript.src = '../atlas-db-jsonp/users/hot.js';
  ...
  height: 100%;
    ...
    async function landscapeFirehose3D() {
      ...
      async function handleFirehose() {
        ...
        const hotUsers = await loadUserList();
